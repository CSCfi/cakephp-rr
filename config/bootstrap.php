...
EventManager::instance()->on('Muffin/OAuth2.newUser',[TableRegistry::getTableLocator()->get('Users'), 'createNewUser']);
EventManager::instance()->on('Muffin/OAuth2.afterIdentify',[TableRegistry::getTableLocator()->get('Tokens'), 'createOrUpdate']);
